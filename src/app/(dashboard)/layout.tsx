...
import { Heart, LayoutDashboard, User, Package, MessageCircle, Trophy, Gift, Building2, AlertTriangle, ClipboardList, Settings, LogOut, Users, Megaphone } from "lucide-react";
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const [userRole, setUserRole] = useState<UserRole | null>("ONG");
    ...
    <div className={styles.container}>
      <aside className={styles.sidebar}>
        <div className={styles.logo}>
          <Heart size={28} fill="#28a745" stroke="#28a745" /> LoveCycle
        </div>
        ...
        <Link href="/" className={styles.navItem} style={{ marginTop: 'auto', color: '#dc3545' }}>
          <LogOut size={20} /> Sair
        </Link>
      </aside>
